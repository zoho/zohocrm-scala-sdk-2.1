...
class SendMailOperations	{
	def getEmailAddresses() :Option[APIResponse[ResponseHandler]]	={
	...
	def sendMail( recordId: Long,  moduleAPIName: String,  request: BodyWrapper) :Option[APIResponse[ActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
