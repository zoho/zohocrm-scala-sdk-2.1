...
class InventoryTemplate extends Template with Model	{
	...
	private var folder:Option[InventoryTemplate] = None
	...
	def getFolder() :Option[InventoryTemplate]	={
		return  this.folder
	}

	def setFolder( folder: Option[InventoryTemplate]) 	={
		 this.folder = folder
