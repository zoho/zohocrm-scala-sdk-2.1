...
class ModulesOperations	{
	def getModules( headerInstance: Option[HeaderMap]=None) :Option[APIResponse[ResponseHandler]]	={
	...
	def getModule( apiName: String) :Option[APIResponse[ResponseHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v2.1/settings/modules/")
	...
	def updateModuleById( id: Long,  request: BodyWrapper) :Option[APIResponse[ActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v2.1/settings/modules/")
