...
class ResponseWrapper extends Model with ResponseHandler	{
	private var assignmentRules:ArrayBuffer[AssignmentRule] = _
	private var keyModified:HashMap[String, Int] = HashMap()

	def getAssignmentRules() :ArrayBuffer[AssignmentRule]	={
		return  this.assignmentRules
	}

	def setAssignmentRules( assignmentRules: ArrayBuffer[AssignmentRule]) 	={
