...
developers := List(
  Developer(
    ...
    url = url("https://github.com/zoho/zohocrm-scala-sdk-2.1")
  )
)
crossPaths := false
pomExtra :=
  <url>https://github.com/zoho/zohocrm-scala-sdk-2.1</url>
    <scm>
      <url>https://github.com/zoho/zohocrm-scala-sdk-2.1</url>
      <connection>scm:git:git@github.com:zoho/zohocrm-scala-sdk-2.1</connection>
    </scm>
licenses := Seq(
